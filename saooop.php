...
<div class="header">
？？通帳
<a class="btn"><div class="header2">検索</div></a>
<div class="drawr">
<div class="ikutumo23">
 <form method="POST" action="saokimi.php">

 年&nbsp;&nbsp;&nbsp;:<input type="text" name="a">
    月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" name="b"><br><br>
    日&nbsp;&nbsp;&nbsp;:<input type="text" name="c">
    カテゴリー:<input type="text" name="d"><br><br>
    金額:<input type="text" name="e"><br>


<p align="right"><input type="submit" value="検索" style="font-size:30px;"></p>
                          ...
                          <br>
                            ".$u2[$s]."／
                                ...
                                ".$e2[$s]."</div>
                                    ...
                                    <div style='position:absolute;top:130px;left:650px;font-size:70px;width:300px;'><font color='green'>".$ka22[$s]."</font></div>
                                     </div>";
               ...
               <br>
                 ".$u2[$s]."／
                     ...
                     ".$e2[$s]."</div>
                         ...
                         <div style='position:absolute;top:130px;left:650px;font-size:70px;width:300px;'><font color='red'>".$ka22[$s]."-</font></div>
                          </div>";
